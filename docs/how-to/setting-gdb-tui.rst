...
The GDB dashboard TUI is very customizable. You can customize the TUI to eliminate the less-commonly used views from the default display during a debug session, such as **Expressions**, **History**, and **Memory** views.
